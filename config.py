# REQUIRED CONFIG
BOT_TOKEN = "5861514867:AAHHPM_5eZY7p1CbhjpXnaDPs4vLhanIXWc5486012197"                              # Require restart after changing it while bot running
OWNER_ID = "5486012197"                               # Require restart after changing it while bot running
TELEGRAM_API = "19876635"                           # Require restart after changing it while bot running
TELEGRAM_HASH = "041240c3224ba59d98eb79a0007b688f"                          # Require restart after changing it while bot running
# OPTIONAL CONFIG
GDRIVE_ID = "1oRFPZhgYlNKLruoepex_boTgkndIRyMi"
IS_TEAM_DRIVE = "True"
...
INDEX_URL = "https://thunder.moviedriveid12.workers.dev/0:/Mirror"
STATUS_LIMIT = ""
STOP_DUPLICATE = "True"
CMD_PERFIX = ""                              # Require restart after changing it while bot running
UPTOBOX_TOKEN = ""
TORRENT_TIMEOUT = ""
EXTENSION_FILTER = ""
